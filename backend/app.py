...
with open('/Users/shreedharraj/Desktop/venturely/backend/model.pkl', 'rb') as f:
    model, label_encoders = pickle.load(f)

DATABASE_URL = 'sqlite:////Users/shreedharraj/Desktop/venturely/backend/business_data.db'
