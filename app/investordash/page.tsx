...
export default function Dashboard() {
  ...
  return (
    <div className="bg-white h-full text-black">
      ...
      <div className="flex items-center justify-center">
        <div className="w-[300px] h-[100px] border border-gray-500 mt-4 ml-4">
          ...
          <div className="flex items-center justify-between">
            <h1 className="text-lg font-bold px-4 mt-2">Hello!</h1>
            <div className="mr-4">
              <UserButton />
            </div>
          </div>
          <h1 className="text-sm font-extralight px-4 text-black">
            Manage your profile
          </h1>
        </div>
      ...
      {isModalOpen && (
        <div className="fixed top-0 left-0 w-screen h-screen bg-white bg-opacity-70 border flex justify-center items-center ">
      ...
      <div className="overflow-x-auto max-w-40 ma mt-20 ml-4 mr-4 rounded-lg">
          ...
          <tbody className="bg-white divide-y divide-gray-300">
            {filteredData.map((company, index) => (
              <tr key={index}>
                ...
                <td className="px-6 py-4 whitespace-wrap border-b border-gray-400 text-black">
                  {company.email}
                </td>
                <td className="px-6 py-4 whitespace-wrap border-b border-gray-400 text-black">
                  {company.country}
